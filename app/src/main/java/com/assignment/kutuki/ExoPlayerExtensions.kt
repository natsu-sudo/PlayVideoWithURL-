...
fun SimpleExoPlayer.preparePlayer(playerView: PlayerView, forceLandscape:Boolean = true) {
    (playerView.context as AppCompatActivity).apply {
        ...
        normalScreenButton.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.ic_fullscreen_exit))
